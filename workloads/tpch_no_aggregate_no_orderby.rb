...
NoSE::Workload.new do
  ...
  Group 'Group1', default: 1 do
    ...
    #      p_partkey;
      ...
      'WHERE part.p_size = ? AND part.p_type = ? AND to_region.r_name = ? AND from_partsupp.ps_supplycost = ? -- Q2_outer'
...
#    #    o_orderdate;
    ...
    Q 'SELECT lineitem.l_orderkey, lineitem.l_extendedprice, lineitem.l_discount, to_orders.o_orderdate, to_orders.o_shippriority '\
      ...
      'WHERE to_customer.c_mktsegment = ? AND to_orders.o_orderdate < ? AND lineitem.l_shipdate > ? -- Q3'
...
#    #     o_orderpriority;
    Q 'SELECT to_orders.o_orderpriority, to_orders.o_orderkey, to_orders.o_orderstatus, to_orders.o_totalprice, ' \
      ...
      'WHERE to_orders.o_orderkey = ? AND to_orders.o_orderdate >= ? AND to_orders.o_orderdate < ? AND lineitem.l_commitdate < ? AND lineitem.l_receiptdate > ? -- Q4'
#
#    # === Q5 ===
#    #   select
#    #     n_name,
...
#    #     revenue desc;
 ...
 Q 'SELECT to_nation.n_name, lineitem.l_extendedprice, lineitem.l_discount ' \
   ...
   'WHERE to_region.r_name = ? AND to_orders.o_orderdate >= ? AND to_orders.o_orderdate < ? -- Q5'
#
#    # === Q6 ===
#    #   select
...
#    #     and l_quantity < [QUANTITY];
    ...
    Q 'SELECT to_nation.n_name, lineitem.l_shipdate, '\
      ...
      'WHERE lineitem.l_orderkey = ? AND lineitem.l_shipdate < ? AND lineitem.l_shipdate > ? -- Q7'
    ...
    Q 'SELECT to_orders.o_orderdate, from_lineitem.l_extendedprice, from_lineitem.l_discount, to_nation.n_name '\
      ...
      'WHERE to_region.r_name = ? AND to_orders.o_orderdate < ? AND to_orders.o_orderdate > ? AND part.p_type = ? -- Q8'
    ...
    Q 'SELECT to_nation.n_name, to_orders.o_orderdate, from_lineitem.l_extendedprice, from_lineitem.l_discount, '  \
      ...
      'WHERE part.p_name = ? AND from_lineitem.l_orderkey = ? -- Q9'
