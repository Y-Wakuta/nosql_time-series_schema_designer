...
NoSE::TimeDependWorkload.new do
  ...
  DefinitionType DEFINITION_TYPE::FLOAT_ARRAY
  ...
  CreationCoeff 0.000001
  MigrateSupportCoeff 0.00000001

  increase = Proc.new() {|base| (0...timesteps).map{|t_| base * ((1 + percentage) ** t_)}}
  decrease = Proc.new() {|base| (0...timesteps).map{|t_| base * ((1.0 - percentage) ** t_)}}

  # aggregation checked
  Group 'BrowseCategories', browsing: decrease.call(4.44),
        bidding: decrease.call(7.65) do
  ...
  Group 'ViewBidHistory', browsing: decrease.call(2.38),
        bidding: decrease.call(1.54) do
  ...
  # aggregation checked
  Group 'ViewItem', browsing: decrease.call(22.95),
        bidding: decrease.call(14.17) do
  ...
  Group 'SearchItemsByCategory', browsing: decrease.call(27.77),
        bidding: decrease.call(15.94) do
  ...
  Group 'ViewUserInfo', browsing: decrease.call(4.41),
        bidding: decrease.call(2.48) do
  ...
  Group 'RegisterItem', bidding: increase.call(0.53) do
  ...
  Group 'RegisterUser', bidding: increase.call(1.07) do
  ...
  # aggregation checked
  Group 'PutBid', bidding: decrease.call(5.40) do
    Q 'SELECT users.nickname FROM users WHERE users.id=? -- 17'
  ...
  Group 'StoreBid_SELECT', bidding: decrease.call(3.74) do
    Q 'SELECT items.nb_of_bids, items.max_bid FROM items WHERE items.id=? -- 21'
  end

  Group 'StoreBid_UPSERT', bidding: increase.call(3.74) do
  ...
  Group 'PutComment', bidding: decrease.call(0.46) do
  ...
  Group 'StoreComment_SELECT', bidding: decrease.call(0.45) do
    Q 'SELECT users.rating FROM users WHERE users.id=? -- 26'
  end

   Group 'StoreComment_UPSERT', bidding: increase.call(0.45) do
  ...
  # aggregation checked
  Group 'AboutMe', bidding: decrease.call(1.71) do
    ...
    # new aggregate
    Q 'SELECT item.id, item.max_bid FROM users.bids.item WHERE users.id=? AND item.end_date>=? GROUP BY item.id'
    Q 'SELECT items.* FROM items WHERE items.id=? -- 18'
    Q 'SELECT users.nickname FROM users WHERE users.id=? -- 23'
    Q 'SELECT items.* FROM items.bids.user WHERE user.id=? AND items.end_date>=? GROUP BY items.id -- 34'
  end

  Group 'SearchItemsByRegion', browsing: decrease.call(8.26),
        bidding: decrease.call(6.34) do
    Q 'SELECT items.id, items.name, items.initial_price, items.max_bid, ' \
  ...
  Group 'BrowseRegions', browsing: decrease.call(3.21),
        bidding: decrease.call(5.39) do
    # XXX Must have at least one equality predicate
